...
class Lex:
    def __init__(self,lista):
        ...
        self.listaSignos=[',',')','(','{','}','_',';','#','"']
        self.listaplabrasreservadas=["&int","&float","&chr","&str","&bool","&Start","&End","&print","&read","true","false"]
        self.variables=[]
        self.valorVariables=[]
        self.tablaTokens=[]
        self.tablaTipo=[]
    ...
    def proces(self):
        ...
        for k in codigo_separado:
            ...
            if count==len(codigo_separado)-1:
                ...
                for j in token:
                    ...
                    elif tokens=="true" or tokens=="false": #verifica si es un booleano
                        #print("Booleano")
                        banTabla=True
                        banPReservada=True
        ...
        if len(self.tablaErrores)==0:
            print("No hay errores lexicos - Proceso lexico terminado correctamente")
            return 1,codigo_separado,mostrarToken,mostrarTipo,mostrarDeclara,mostrarReferencia,self.tablaErrores
        else:
            print("Hay errores lexicos - Proceso lexico terminado con errores")
            return 0,codigo_separado,mostrarToken,mostrarTipo,mostrarDeclara,mostrarReferencia,self.tablaErrores
